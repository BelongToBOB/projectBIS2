...
print("***************** Result ****************")
print("ชื่อ: ", name)
print("ปี เกิด: ", yearBirth)
print("อายุ: ", age)
print("เพศ: ", strGender)
print("สถานะการท างาน: ", strJob)

if age>=60:
    print("{0:<50s}{1:>10,.2f} บาท".format("ค่าครองชีพคนชรา:",
        livingAllowance))
    
if job == 0:
    print("{0:<50s}{1:>10,.2f}บาท".format("เงินเดือน:",salary))
    print("{0:<50s}{1:>10,.2f}บาท".format("รายได้ทั้งปี:",incomes))
    print("{0:<50s}{1:>10,.2f}บาท".format("รายได้หลังหักลดหย่อน:",
            net))
    print("{0:<50s}{1:>10,.2f}บาท".format("ภาษีที่ต้องช าระ:", tax))
